...
* Return         : None
*********************************************************************************/
void ecc_memcpy(UINT32 *pDst,const UINT32 *pSrc, DWORD cnt);
/*********************************************************************************
...
/*********************************************************************************
* Function Name  : ECC_cov_mon
* Description    : convert normal number to montgomery number(only for A,B)
* Input          : - *in_data    : input number for RSA modular exp operation
				 : - in_length   : length of in_data, in words
				 : - *e_data     : exponent for RSA modular exp operation
				 : - e_length    : length of e_data, in words 				 
...
/*********************************************************************************
* Function Name  : ECC_cov_Bnor
* Description    : convert  montgomery number to normal number to(only for B)
* Input          : NONE 				 
* Output         : - *out_data   : result for normal number
				 : - *out_length : length of output, in words 
* Return         : NONE
*********************************************************************************/
void ECC_cov_Bnor(     
