 ...
 * All rights reserved.
 * Filename    : rsa_keygen.h
 * Description : rsa keygen driver header file
 * Author(s)   : Eric  
 * version     : V1.0
 * Modify date : 2016-03-24
 ***********************************************************************/
#ifndef __RSA_KEGGEN_H__
#define __RSA_KEGGEN_H__ 
...
#define MAX_RSA_MODULUS_BITS 2048  //1024 or 2048
...
* Return         : NONE
******************************************************************************/
void NN_ModInv_variable_initial(MATH_G_STR *p_math_str,UINT32 max_nn_digits);
